...
Router.post('/', async function (req, res) {
    ...
    if (search == "") {
        ...
        try{
            ...
            strsql = strsql + ` AND Emp_MainFirstName LIKE '%${search}%'`;
            strsql = strsql + ` OR Emp_MainLastname LIKE '%${search}%'`;
...
Router.post('/add', upload.single("Image"),
    ...
    async function (req, res) {
        ...
        try {
            ...
            // IMAGE  Working, nothing else is needed
